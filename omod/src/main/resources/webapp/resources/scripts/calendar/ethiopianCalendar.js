jQuery(function () {
  ...
  jQuery("#userEnteredParamstartDate").calendarsPicker({
    onSelect: function ethToGreg(ethdate) {
      ...
      if (dmy.length == 3) {
        ...
        var appdategcstr = jQuery.calendars
          .instance("gregorian")
  ...
  jQuery("#userEnteredParamendDate").click(function () {
    jQuery("#userEnteredParamendDate")
      .val("")
      .calendarsPicker("option", { dateFormat: "mm/dd/yyyy" });
  });

  jQuery("#userEnteredParamstartDate").click(function () {
    jQuery("#userEnteredParamstartDate")
      .val("")
      .calendarsPicker("option", { dateFormat: "mm/dd/yyyy" });
  });
});
function showCalendar(obj, yearsPrevious) {
  ...
  if (gp.weekStart) opts["firstDay"] = gp.weekStart;
